...
const SunnyIcon: React.FC<SunnyIconProps> = ({ width = 100, height = 100, color = 'orange', className }) => {
  return (
    <svg
    ...
    >
      <circle cx="32" cy="32" r="14" fill={color} /> // Ensure fill color is applied here
