...
from api.views.view_division import greek_municipalities  # Import the new view
...
urlpatterns = [
    ...
    path('geography/greece/municipalities/', greek_municipalities, name='greek_municipalities'),  # Add this line
]
